...
public class MailService {
    ...
    private static final String USER = "klamia17";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
    private static final String PASSWORD = "paradis"; // Must be valid password for smit0012
    private static final String FROM = "klamia17@gmail.com";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
}
